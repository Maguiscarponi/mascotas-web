        ...
        <div class="col-md-4">
            <div class="card card-reportar">
                <div class="card-body">
                    ...
                    <a href="mascotas_adopcion.php" class="btn btn-tarjetasindex">Ver mascotas</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 card-transito">
                <div class="card-body">
                    ...
                    <a href="mascotas_transito.php" class="btn btn-tarjetasindex">Ver mascotas</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 card-perdidas">
                <div class="card-body">
                    ...
                    <a href="mascotas_perdidas.php" class="btn btn-tarjetasindex">Ver mascotas</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card h-100 card-reportar">
                <div class="card-body">
                    ...
                    <a href="mascotas_perdidas.php" onclick="iniciarChat(); return false;" class="btn btn-tarjetasindex">Reportar</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card h-100 card-donacion">
                <div class="card-body">
                    ...
                    <a href="realizar_donacion.php" class="btn btn-tarjetasindex">Donar</a>
                </div>
            </div>
        </div>
    </div>
