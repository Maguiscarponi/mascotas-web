        ...
        <div class="cuerpo-formulario-principal">
            ...
            <form action="procesar_transito.php" method="POST">
                ...
                <div class="fila-formulario-principal">
                    <div class="columna-formulario-principal">
                        <div class="grupo-campo-formulario">
                            <label for="nombre_mascota" class="etiqueta-formulario-principal">Nombre de la mascota para dar tránsito</label>
                            <input type="text" 
                                   class="input-formulario-principal" 
                                   id="nombre_mascota" 
                                   name="nombre_mascota" 
                ...
                <!-- Cuarta fila: Cubre gastos -->
                <div class="fila-formulario-principal">
                    <div class="columna-formulario-principal">
                        <div class="grupo-campo-formulario">
                            <label class="etiqueta-formulario-principal">¿Puede cubrir gastos básicos de alimentación y cuidados?</label>
                            <div class="grupo-radio-formulario">
                                <div class="opcion-radio-formulario">
                                    <input class="radio-formulario-principal" 
                                           ...
                                           id="gastos_si" 
                                           required>
                                    <label class="etiqueta-radio-formulario" for="gastos_si">Si</label>
                                </div>
                                <div class="opcion-radio-formulario">
                                    <input class="radio-formulario-principal" 
                                           type="radio" 
                                           ...
                                           id="gastos_no" 
                                           required>
                                    <label class="etiqueta-radio-formulario" for="gastos_no">No</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Quinta fila: Acepta visita -->
                <div class="fila-formulario-principal">
                    <div class="columna-formulario-principal">
                        <div class="grupo-campo-formulario">
                            <label class="etiqueta-formulario-principal">Disponibilidad para recibir visitas de seguimiento:</label>
                            <div class="grupo-radio-formulario">
                                <div class="opcion-radio-formulario">
                                    <input class="radio-formulario-principal" 
                                           type="radio" 
                                           ...
                                           id="visita_si" 
                                           required>
                                    <label class="etiqueta-radio-formulario" for="visita_si">Si</label>
                                </div>
                                <div class="opcion-radio-formulario">
                                    <input class="radio-formulario-principal" 
                                           type="radio" 
                                           ...
                                           id="visita_no" 
                                           required>
                                    <label class="etiqueta-radio-formulario" for="visita_no">No</label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grupo-radio-vertical">
                                <div class="opcion-radio-vertical">
                                    <input class="radio-formulario-principal" 
                                           ...
                                           id="casa_patio" 
                                           required>
                                    <label class="etiqueta-radio-formulario" for="casa_patio">Casa con patio</label>
                                </div>
                                <div class="opcion-radio-vertical">
                                    <input class="radio-formulario-principal" 
                                           type="radio" 
                                           ...
                                           id="casa_sin_patio">
                                    <label class="etiqueta-radio-formulario" for="casa_sin_patio">Casa sin patio</label>
                                </div>
                                <div class="opcion-radio-vertical">
                                    <input class="radio-formulario-principal" 
                                           type="radio" 
                                           ...
                                           id="depto_chico">
                                    <label class="etiqueta-radio-formulario" for="depto_chico">Departamento chico</label>
                                </div>
                                <div class="opcion-radio-vertical">
                                    <input class="radio-formulario-principal" 
                                           type="radio" 
                                           ...
                                           id="depto_grande">
                                    <label class="etiqueta-radio-formulario" for="depto_grande">Departamento grande</label>
                                </div>
                            </div>
                        </div>
                    </div>
