...
//En este archivo voy a mostrar la interfaz del chat del lado del usuario y la lógica para mandar y recibir los mensajes
...
// Validación: si no tengo el ID del chat, redirijo al index (inicio)
if (!isset($_GET['id'])) {
...
// Verificación que el usuario tiene acceso al chat
...
<style>
/* Estilos provisionales, meterlos en el styles.css cuando estén definidos 100%*/
.mensaje-usuario {
  display: flex;
...
<div class="chat-container mt-4">
    <!-- Información para dar un poquito de contexto -->
    ...
    <div class="card chat-card">
        <div class="card-header bg-primary text-white">
            <h6 class="mb-0"><i class="fas fa-comments"></i> Comunicate con Adoptame Saladillo</h6>
        </div>

        <div class="card-body chat-messages p-0" id="chat-body">
            <div id="chat-mensajes">
                <!-- Acá se cargan los mensajes -->
            </div>
        </div>
        ...
        <div class="card-footer bg-light">
            <form id="chat-form">
                <div class="input-group">
                    ...
                    <button type="button" class="btn btn-outline-secondary" onclick="document.getElementById('imagen-input').click()" title="Subir imagen">
...
<!-- Conexión con servidor de websocket -->
